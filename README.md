# Starter — Desktop-Anwendungen mit Tauri, Weboberfläche und Kommandozeile
...
│
├── cli/                     ← Kommandozeile `starter`. Dünn.
│
...
└── package-cli.sh           dist/starter-cli-<version>-<os>-<arch>.tar.gz
```
